...
class ox extends Frame implements MouseListener {
    ...
    Label l1, l2, gameName, l3, gameOver;
    ...
    ox() {
        ...
        gameOver.setBounds(240, 120, 200, 30);
        ...
        rematch.setBounds(540, 440, 126, 60);
        rematch.setBackground(Color.green);
        rematch.setForeground(Color.black);
        rematch.setFont(new Font("serif", Font.BOLD, 20));
        add(rematch);
